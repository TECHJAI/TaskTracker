		...
		<?php
			...
			if($result->num_rows>0)	
			{
				...
				while ($row = $result->fetch_assoc()) {
					...
					if($No%2 == 0)
					{
						echo "<tr class='even_row' align='center'><td>".$No."</td><td align='left'><b>Name:</b>".$row["Name"]."<br><b>Primitive Role :</b>".$row["primitiverole"]."<br><b>Mail:</b>".$row["email"]."</td><td><b>Username:</b>".$row["username"]."<br><b>Password:</b>".$row["password"]."</td>";
					}
					else
					{
						echo "<tr class='odd_row' align='center'><td>".$No."</td><td align='left'><b>Name:</b>".$row["Name"]."<br><b>Primitive Role :</b>".$row["primitiverole"]."<br><b>Mail:</b>".$row["email"]."</td><td><b>Username:</b>".$row["username"]."<br><b>Password:</b>".$row["password"]."</td>";
					}
                    ?>
