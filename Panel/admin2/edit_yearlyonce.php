...
<?php
    ...
    <?php require 'edit_yearlyonce_backend.php'; ?>
    <div class = "container login-cont">
        <div class="form-box px-5 py-4">
            <form action="edit_yearlyonce_backend.php" method="post">
                ...
                <input type="date" name="E_" class="form-control" value="<?php echo $R_date; ?>">
                <label>Remarks :</label>
