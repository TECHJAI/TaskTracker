		...
		<?php
			...
			if($result->num_rows>0)	
			{
				...
				while ($row = $result->fetch_assoc()) {
					...
					$e_date = date('d-m',strtotime($row["R_date"]));
					...
					else
					{
						echo "<tr class='odd_row'><td>".$No."</td><td>".$t_date."</td><td>".$row["Event"]."</td><td>".$e_date."</td>";
		                     ...
		                     //$sdate=$t_date;
                                   ...
                                   $end_date = date(strtotime($row['R_date']));
                    		...
                    		<td>
	 			<button class="mod1 btn btn-primary"><a href="edit_yearlytwise.php?edit=<?php echo $row['ID']; ?>"><i class="fa-solid fa-pen-to-square"></i></a></button>
	 			<button class="mod2"><a href="edit_yearlytwise_backend.php?delete=<?php echo $row['ID']; ?>"><i class="fa-solid fa-trash"></i></a></button>
	 			</td>   
