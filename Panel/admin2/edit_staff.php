...
<?php
    ...
    <?php require 'process_edit_staff.php'; 
    require "../../db.php";
    ?>
    <div class = "container login-cont">
        <div class="form-box px-5 py-4">
            <form action="process_edit_staff.php" method="post">
                ...
                <input type="text" name="Name" class="form-control" value="<?php echo $Name; ?>" placeholder="Enter Name"><br>
                <label>Primitive Role :</label>
                <input type="text" name="primitive" class="form-control" value="<?php echo $primitive; ?>" placeholder="Enter Name"><br>
                <label>User Name :</label>
                <input type="text" name="log_id" class="form-control" value="<?php echo $dep_id; ?>" placeholder="User Name for Department admin"><br>
                <label>Password :</label>
                <input type="password" name="pass" class="form-control" value="<?php echo $pass; ?>" placeholder="Password for User Name"><br>
                <label>Confirm Password :</label>
                <input type="password" name="cass" class="form-control" value="<?php echo $pass; ?>" placeholder="Password for User Name"><br>
