...
<?php
    ...
    <?php require 'process_management_staff.php'; 
    require "../../db.php";
    ?>
    <div class = "container login-cont">
        <div class="form-box px-5 py-4">
            <form action="process_management_staff.php" method="post">
                <input type="hidden" name="ID" value="<?php echo $ID; ?>">
                <label>Staff Name :</label>
                <input type="text" name="Name" class="form-control" value="<?php echo $Name; ?>" placeholder="Enter Staff Name"><br>
                <label>Staff Role :</label>
                <input type="text" name="Role" class="form-control" value="<?php echo $Role; ?>" placeholder="Enter Staff Role"><br>
                <label>User Name :</label>
                <input type="text" name="log_id" class="form-control" value="<?php echo $log_id; ?>" placeholder="Enter User Name"><br>
                <label>Password :</label>
                <input type="password" name="pss" class="form-control" value="<?php echo $pss; ?>" placeholder="Enter password"><br>
                <button type="submit" name="update" class="subm-btn form-control">Save</button>
            </form>
        </div>
    </div>
</body>
