...
<?php
    ...
    <?php require 'process_add_hod.php'; 
    require "../../db.php";?>
    <div class = "container login-cont">
        <div class="form-box px-5 py-4">
            <form action="process_add_hod.php" method="post">
            ...
            <input type="date" name="Dead_Line" class="form-control" value="<?php echo $Dead_Line; ?>" min="<?php echo $today; ?>"><br>
            <label>Remarks :</label>
