...
if (isset($_POST['update'])) {
	...
	$db -> query("UPDATE tasks SET From1 = '$From1',Role1 = '$Role1',Dep1 = '$Dep1',To2 = '$To2',Role2 = '$Role2',Dep2 = '$Dep2',Task = '$Task',Begins = '$Begins',Ends = '$Ends',Remarks = '$Remarks' WHERE ID='$ID'") or die($mysqli -> error());
